...
public class GridTest1 {
	 ...
	 * 
	 * console URL : http://192.168.1.135:4444/grid/console
	 * 
	 ...
	 * Node URL (ff+chrome)
	 * java -Dwebdriver.chrome.driver="C:\RadicalSeleniumB15\softwares\Phase 3\chromedriver_win32_B39\chromedriver.exe" -Dwebdriver.gecko.driver="C:\RadicalSeleniumB15\softwares\Phase 3\geckodriver-v0.18.0-win64\geckodriver.exe" -jar selenium-server-standalone-3.5.2.jar -role node -hub http://192.168.43.251:4444/grid/register/ -browser "browserName=firefox,version=ANY,platform=WINDOWS,maxInstances=5" -browser "browserName=chrome,version=ANY,platform=WINDOWS,maxInstances=5" -maxSession 5
	 * 
	...
	*/
	...
	public void test1(String browserName) throws MalformedURLException, InterruptedException{
		...
		System.out.println("test1: browserName " + browserName);
		...
		/*Add IE Code here same as above*/
		if(browserName.equals("IE")){
			...
			capabilities.setPlatform(Platform.ANY);
			capabilities.setPlatform(org.openqa.selenium.Platform.WINDOWS);
			capabilities.setCapability("internetExplorer.switches", Arrays.asList("--disable-extensions"));
	...
	public void test2(String browserName) throws MalformedURLException, InterruptedException{
		...
		WebDriver driver = null;
		System.out.println("test2: browserName " + browserName);
		if(browserName.equals("firefox")){
			DesiredCapabilities capabilities = new DesiredCapabilities();
			capabilities =DesiredCapabilities.firefox();
			capabilities.setBrowserName(browserName);
